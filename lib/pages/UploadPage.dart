        ...
        return SimpleDialog(
          ...
          children: <Widget>[
            SimpleDialogOption(
             ...
             SimpleDialogOption(
              child: Text("Select Image from Galery", style: TextStyle(color: Colors.white),),
  ...
  displayUploadFormScreen(){
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("New Post", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 24.0,),),
        actions: <Widget>[
          FlatButton(
            onPressed: uploading ? null : () => controlUploadAndSave(), 
            child: Text("Next", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 16.0),)
            )
        ],
      ),
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            Divider(),
            ListTile(
              leading: Icon(Icons.person_pin_circle, color: Colors.green, size: 36.0,),
              title: Container(
                width: 250.0,
                child: TextField(
                  style: TextStyle(color: Colors.black),
