  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(onPressed: ()=> Navigator.pop(context), icon: Icon(Icons.done), color: Colors.black, iconSize: 30.0,)
        ],
      ),
            ...
            child: Column(
              children: <Widget>[
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 52.0,
                    backgroundImage: CachedNetworkImageProvider("https://lh3.googleusercontent.com/a-/AOh14GiVUuSLwKGUAa733u8shKki3uc9JnqT7ISl6_htMA=s96-c"),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.all(16.0),
