        ...
        child: Column(
          children: <Widget>[
            GestureDetector(
              ...
              child: ListTile(
                leading: 
                CircleAvatar(backgroundColor: Colors.black, backgroundImage: /*eachUser.url == null || eachUser.url.isEmpty ? AssetImage('assets/images/mbappe.jpg') :*/  CachedNetworkImageProvider(eachUser.url)),
